    ...
    public function list(Request $request){
        ...
        try {
            ...
            $pageNum = ($request->pageNum)?$request->pageNum:1;
                ...
                $query =  DeviceProfile::select('id', 'name', 'is_default as default','version','created_by as createdBy','create_ts as createdTime','updated_by as lastUpdatedBy','update_ts as lastUpdateTime')
